...
type AppRepository interface {
	...
	CreateApp(appName string, logo string, ctx context.Context) (interface{}, error)
	ListApps(ctx context.Context) ([]*model.App, error)
	DeleteApp(id primitive.ObjectID, ctx context.Context) (int64, error)
	UpdateApp(id primitive.ObjectID, appName string, logo string, ctx context.Context) (interface{}, error)
