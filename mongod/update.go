...
func (c *appRepository) UpdateApp(id primitive.ObjectID, appName string, logo string, tuf bool, description string, reports bool, owner string, ctx context.Context) (interface{}, error) {
	filter := bson.D{{Key: "_id", Value: id}}
